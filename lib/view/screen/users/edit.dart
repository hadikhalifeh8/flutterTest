...
import 'package:small_tesr/controller/users/editController.dart';
...
class EditUser  extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    body:
          GetBuilder<EditUserController>(builder: (controller)
          =>
     ...
     CustomButton(
                  onPressed_: (){
                    controller.edit(controller.usersModel!.id.toString());
                    }, 
                  text_: "Submit",
                  ),
